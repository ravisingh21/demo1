<ul class="nav nav-tabs control">
  ...
  <li role="presentation"><a href="/admin/mizaz" class="btn">Mizaz</a></li>
  <li role="presentation"><a href="/admin/ravish_ki_report" class="btn">Ravish ki Report </a></li>
  <li role="presentation"><a href="/admin/hindi_patti" class="btn">Hindi Patti </a></li>
  <li role="presentation"><a href="/admin/nai_sadak" class=" btn glyphicon glyphicon-home" > Nai Sadak </a></li>
